...
Presently, there are a handful of configuration languages. These languages are in their infancy, so this survey only attempts to draw attention to their prominent features.

\paragraph{Coil:} \url{https://code.google.com/p/coil/} \\
\emph{Paradigm:} Functional, side-effect free, prototype inheritance \\
\emph{Typing Discipline:} String, dynamic \\
\emph{Turing Complete:} No \\
\emph{Scoping:} Lexical \\
\emph{Default Propagation:} Inheritance \\
\emph{Output Format:} Python objects
...
\emph{Paradigm:} Functional, side-effect free, prototype inheritance \\
\emph{Typing Discipline:} Strong, dynamic, duck \\
\emph{Turing Complete:} Yes \\
\emph{Scoping:} Dynamic \\
\emph{Default Propagation:} Dynamic scope, Inheritance \\
\emph{Output Format:} Text, Custom
...
\emph{Paradigm:} Functional, side-effect free \\
\emph{Typing Discipline:} Strong, dynamic, duck\\
\emph{Turing Complete:} Yes \\
\emph{Scoping:} Lexical \\
\emph{Default Propagation:} Operator\\
\emph{Output Format:} Custom
...
\emph{Paradigm:} Imperative, tuple-space \\
\emph{Typing Discipline:} Strong, static-dynamic hybrid, check-on-assignment \\
\emph{Turing Complete:} Yes \\
\emph{Scoping:} Lexical \\
\emph{Default Propagation:} Inherited \\
\emph{Output Format:} JSON, XML
...
\textbf{Paradigm:} Imperative~(By Python), immutable, class-based \\
\textbf{Typing Discipline:} Strong, dynamic, check-on-request \\
\textbf{Turing Complete:} Yes~(By Python) \\
\textbf{Scoping:} Dynamic, Lexical for the Python components \\
\textbf{Default Propagation:} Inheritance \\
\textbf{Output Format:} Python
